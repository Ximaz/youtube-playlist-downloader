...
import YoutubeArtifactPublisherService from "@/services/YoutubeArtifactPublisherService.js";
...
import CompressVideosService from "@/services/CompressVideosService.js";
...
videosRouter.post("/export", zValidator("json", videosExportDto), async (c) => {
  ...
  const compressVideosService = new CompressVideosService(
